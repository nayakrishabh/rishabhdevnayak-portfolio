...
const Resume = () => (
  <Layout>
    ...
    <section className="container pb-16 grid lg:grid-cols-3 gap-6">
      <Reveal as="aside" className="glass rounded-2xl p-7 space-y-5 lg:col-span-1 h-fit">
        <div>
        ...
        <div className="space-y-3 text-sm">
          ...
          <a href={profile.linkedin} target="_blank" rel="noreferrer" className="flex items-center gap-3 hover:text-primary transition-colors break-all">
            <Linkedin className="h-4 w-4 text-primary" /> LinkedIn
          </a>
        </div>
        <Button asChild className="w-full bg-gradient-primary text-primary-foreground hover:opacity-90 glow">
      ...
      <Reveal delay={120} className="lg:col-span-2 glass rounded-2xl p-2 overflow-hidden">
